...
int DHCP::writeResponse(Packet* packet, int offset, uint32_t transaction_id, struct in_addr client_in_addr, struct in_addr, ether_addr client_ether_addr, struct in_addr server_identifier, struct in_addr subnet_mask, struct in_addr router, std::vector<struct in_addr> dns_vector)
{
